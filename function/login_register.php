...
if (isset($_POST['ubat_pelanggan'])) {
    ...
    $nama_pelanggan_ubah = filter_var($_POST['nama_pelanggan_ubah'], FILTER_SANITIZE_STRING);
    ...
    $update = mysqli_query($con, "UPDATE user_public SET Password = '$password_pelanggan_ubah', Email = '$email_pelanggan_ubah', Nama = '$nama_pelanggan_ubah', Alamat = '$alamat_pelanggan_ubah' WHERE Username = '$username_pelanggan_ubah'");
